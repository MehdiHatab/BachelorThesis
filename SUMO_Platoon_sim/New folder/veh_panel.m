...
if t == 0
    ...
    leave_req = uicontrol(vehicle_info,'Style','pushbutton','Position',...
        [200,100,100,50],'String','Leave','Enable','off')
    ...
    all_vehicle.String = {'flow.0','flow.1','flow.2','flow.3','flow.4','flow.5',...
        'flow.6','flow.7','flow.8'};

    near_vehicle.String = all_vehicle.String(1:5);
    follower_veh.String = near_vehicle.String([1,4]);
    join_req.Callback = {@join_call,near_vehicle};
    leave_req.Callback = {@leave_call,follower_veh};
end
