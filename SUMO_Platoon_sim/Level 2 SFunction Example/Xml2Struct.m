        ...
        for count = 1:numChildNodes
            ...
            if (~strcmp(name,'#text') && ~strcmp(name,'#comment') && ~strcmp(name,'#cdata_dash_section')) 
                ...
                if (isfield(children,name)) 
                    ...
                    dValue          = str2double(text.(thisFieldName));
                    if isnumeric(dValue) && ~isnan(dValue)
                      children.(name) = dValue;
                    else
                      children.(name) = text.(thisFieldName); %children.(name).(thisFieldName) = text.(thisFieldName); 
                    end
                    end 
                    end 
                    if(~isempty(attr)) 
